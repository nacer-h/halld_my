...
{
  TFile *f = NULL;
  if(name == "sim") f = new TFile(Form("/Users/nacer/halld_my/pippimkpkm/input/pippimkpkm__B4_genr8_17v03_%scut.root",cut.Data()));
  if(name == "data") f = new TFile(Form("/Users/nacer/halld_my/pippimkpkm/input/pippimkpkm__B4_17v21_%scut.root",cut.Data()));
  ...
  h_BeamEnergy->Draw();
  c_BeamEnergy->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_BeamEnergy.root",name.Data()), "root");
  c_BeamEnergy->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_BeamEnergy.eps",name.Data()), "eps");
  ...
  c_kkmm->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_kkmm.root",name.Data()), "root");
  c_kkmm->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_kkmm.eps",name.Data()), "eps");
  ...
  if(name=="sim")
  {
    ...
    h_kkmm_Thrown->Draw();
    c_kkmm_Thrown->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_kkmm_Thrown.root",name.Data()), "root");
    c_kkmm_Thrown->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_kkmm_Thrown.eps",name.Data()), "eps");
  }
  ...
  l_PhiMass_precut->AddEntry(h_PhiMass_beambunchcut, "KinFit + accidental subtracted","l");
  l_PhiMass_precut->Draw();
  c_PhiMass_precut->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_PhiMass_precut.root",name.Data()), "root");
  c_PhiMass_precut->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_PhiMass_precut.eps",name.Data()), "eps");
  ...
  c_PhiMass_postcut->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_PhiMass_postcut.root",name.Data()), "root");
  c_PhiMass_postcut->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_PhiMass_postcut.eps",name.Data()), "eps");
  ...
  // c_PhiMass_nobeambunchcut->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_PhiMass_%scut_nobeambunchcut.root",name.Data(),cut.Data()), "root");
  // c_PhiMass_nobeambunchcut->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_PhiMass_%scut_nobeambunchcut.eps",name.Data(),cut.Data()), "eps");
  ...
  h_foMass_Measured_precut->Draw();
  h_foMass_KinFit_precut->Draw("same");
  ...
  l_foMass_precut->AddEntry(h_foMass_beambunchcut, "KinFit + accidental subtracted","l");
  l_foMass_precut->Draw();
  c_foMass_precut->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_foMass_precut.root",name.Data()), "root");
  c_foMass_precut->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_foMass_precut.eps",name.Data()), "eps");
  // Zoom in after beam bunch cut
  ...
  // c_foMass_beambunchcut->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_foMass_beambunchcut.root",name.Data()), "root");
  // c_foMass_beambunchcut->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_foMass_beambunchcut.eps",name.Data()), "eps");
  ...
  c_foMass_postcut->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_foMass_postcut.root",name.Data()), "root");
  c_foMass_postcut->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_foMass_postcut.eps",name.Data()), "eps");
  ...
  // c_foMass_nobeambunchcut->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_foMass_%scut_nobeambunchcut.root",name.Data(),cut.Data()), "root");
  // c_foMass_nobeambunchcut->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_foMass_%scut_nobeambunchcut.eps",name.Data(),cut.Data()), "eps");
  ...
  h_YMass_Measured_precut->Draw();
  h_YMass_KinFit_precut->Draw("same");
  ...
  l_YMass_precut->AddEntry(h_YMass_beambunchcut, "KinFit + accidental subtracted","l");
  l_YMass_precut->Draw();
  c_YMass_precut->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_YMass_precut.root",name.Data()), "root");
  c_YMass_precut->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_YMass_precut.eps",name.Data()), "eps");
  // Zoom in after beam bunch cut
  ...
  // c_YMass_beambunchcut->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_YMass_beambunchcut.root",name.Data()), "root");
  // c_YMass_beambunchcut->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_YMass_beambunchcut.eps",name.Data()), "eps");
  ...
  c_YMass_postcut->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_YMass_postcut.root",name.Data()), "root");
  c_YMass_postcut->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_YMass_postcut.eps",name.Data()), "eps");
  ...
  // c_YMass_nobeambunchcut->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_YMass_%scut_nobeambunchcut.root",name.Data(),cut.Data()), "root");
  // c_YMass_nobeambunchcut->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_YMass_%scut_nobeambunchcut.eps",name.Data(),cut.Data()), "eps");
  ...
  c_h2_PhiVsfoMass_Measured->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_h2_PhiVsfoMass_Measured.root",name.Data()), "root");
  c_h2_PhiVsfoMass_Measured->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_h2_PhiVsfoMass_Measured.eps",name.Data()), "eps");
  ...
  c_h2_PhiVsYMass_Measured->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_h2_PhiVsYMass_Measured.root",name.Data()), "root");
  c_h2_PhiVsYMass_Measured->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_h2_PhiVsYMass_Measured.eps",name.Data()), "eps");
  ...
  c_h2_foVsYMass_Measured->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_h2_foVsYMass_Measured.root",name.Data()), "root");
  c_h2_foVsYMass_Measured->Print(Form("/Users/nacer/halld_my/pippimkpkm/fig_y2175/c%s_h2_foVsYMass_Measured.eps",name.Data()), "eps");
