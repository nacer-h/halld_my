...
void scany(int nkk=100, int n2pi2k=100, int ne=1, int nt=1) // , TString cut="&& kin_chisq<30 && abs(mm2)<0.015"
{
  ...
  TCanvas *cphiye=new TCanvas("cphiye","cphiye",1500, 400);//1500, 800
  cphiye->Divide(3,1);
  ...
  TCanvas *cgphiye=new TCanvas("cgphiye","cgphiye",900, 600);//1500, 800
  cgphiye->Divide(3,1);
  ...
  for (int j = 1; j <= ne; ++j)
  {
    ...
    if (j == 1)
    {
      h1d2 = new TH2F("h1d2", "6<E_{#gamma}<8.3 GeV (Data);m_{K^{+}K^{-}#pi^{+}#pi^{-}} [GeV/c^{2}];m_{K^{+}K^{-}} [GeV/c^{2}]", n2pi2k, m2pi2k_min, m2pi2k_max, nkk, mkk_min, mkk_max);
      tdata->Project("h1d2", "kpkm_mf:kpkmpippim_mf", "w8*((kpkm_uni || kpkmpippim_uni) && beam_p4_kin.E()>6 && beam_p4_kin.E()<8.3)");
    }
    if (j == 2)
    {
      h1d2 = new TH2F("h1d2", "8.3<E_{#gamma}<9.3 GeV (Data);m_{K^{+}K^{-}#pi^{+}#pi^{-}} [GeV/c^{2}];m_{K^{+}K^{-}} [GeV/c^{2}]", n2pi2k, m2pi2k_min, m2pi2k_max, nkk, mkk_min, mkk_max);
      tdata->Project("h1d2", "kpkm_mf:kpkmpippim_mf", "w8*((kpkm_uni || kpkmpippim_uni) && beam_p4_kin.E()>8.3 && beam_p4_kin.E()<9.3)");
    }
    if (j == 3)
    {
      h1d2 = new TH2F("h1d2", "9.3<E_{#gamma}<12 GeV (Data);m_{K^{+}K^{-}#pi^{+}#pi^{-}} [GeV/c^{2}];m_{K^{+}K^{-}} [GeV/c^{2}]", n2pi2k, m2pi2k_min, m2pi2k_max, nkk, mkk_min, mkk_max);
      tdata->Project("h1d2", "kpkm_mf:kpkmpippim_mf", "w8*((kpkm_uni || kpkmpippim_uni) && beam_p4_kin.E()>9.3 && beam_p4_kin.E()<12)");
    }
    h1d2->Draw("colz");
    ...
    // if(j==1) gphiye[j]->SetTitle("6<E_{#gamma}<8.3 (Data);m_{#phi#pi^{+}#pi^{-}} [GeV/c^{2}];N_{#phi}");
    // if(j==2) gphiye[j]->SetTitle("8.3<E_{#gamma}<9.3 GeV (Data);m_{#phi#pi^{+}#pi^{-}} [GeV/c^{2}];N_{#phi}");
    // if(j==3) gphiye[j]->SetTitle("9.3<E_{#gamma}<12 GeV (Data);m_{#phi#pi^{+}#pi^{-}} [GeV/c^{2}];N_{#phi}");
...
*/      
  ...
  // ======================================== Y vs. -t ===============================================
/*
  TCanvas *cphiyt=new TCanvas("cphiyt","cphiyt",1500, 400);
  cphiyt->Divide(3,1);

  TCanvas *cphiyt1[nt];
  TCanvas *cphiyt2[nt];

  TCanvas *cgphiyt=new TCanvas("cgphiyt","cgphiyt",1500, 400);
  cgphiyt->Divide(3,1);
  ...
  for (int j = 1; j <= nt; ++j)
  {
    ...
    if (j == 1)
    {
      h1d2 = new TH2F("h1d2", "0<-t<0.7 GeV (Data);m_{K^{+}K^{-}#pi^{+}#pi^{-}} [GeV/c^{2}];m_{K^{+}K^{-}} [GeV/c^{2}]", n2pi2k, m2pi2k_min, m2pi2k_max, nkk, mkk_min, mkk_max);
      tdata->Project("h1d2", "kpkm_mf:kpkmpippim_mf", "w8*((kpkm_uni || kpkmpippim_uni) && beam_p4_kin.E()>6 && -t_kin>0 && -t_kin<0.7)");
    }
    if (j == 2)
    {
      h1d2 = new TH2F("h1d2", "0.7<-t<1.5 GeV (Data);m_{K^{+}K^{-}#pi^{+}#pi^{-}} [GeV/c^{2}];m_{K^{+}K^{-}} [GeV/c^{2}]", n2pi2k, m2pi2k_min, m2pi2k_max, nkk, mkk_min, mkk_max);
      tdata->Project("h1d2", "kpkm_mf:kpkmpippim_mf", "w8*((kpkm_uni || kpkmpippim_uni) && beam_p4_kin.E()>6 && -t_kin>0.7 && -t_kin<1.5)");
    }
    if (j == 3)
    {
      h1d2 = new TH2F("h1d2", "1.5<-t<4 GeV (Data);m_{K^{+}K^{-}#pi^{+}#pi^{-}} [GeV/c^{2}];m_{K^{+}K^{-}} [GeV/c^{2}]", n2pi2k, m2pi2k_min, m2pi2k_max, nkk, mkk_min, mkk_max);
      tdata->Project("h1d2", "kpkm_mf:kpkmpippim_mf", "w8*((kpkm_uni || kpkmpippim_uni) && beam_p4_kin.E()>6 && -t_kin>1.5 && -t_kin<4)");
    }
    ...
    if(j==1) gphiyt[j]->SetTitle("0<-t<0.7 GeV (Data);m_{#phi#pi^{+}#pi^{-}} [GeV/c^{2}];N_{#phi}");
    if(j==2) gphiyt[j]->SetTitle("0.7<-t<1.5 GeV (Data);m_{#phi#pi^{+}#pi^{-}} [GeV/c^{2}];N_{#phi}");
    if(j==3) gphiyt[j]->SetTitle("1.5<-t<4 GeV (Data);m_{#phi#pi^{+}#pi^{-}} [GeV/c^{2}];N_{#phi}");
    ...
    cphiyt1[j]->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_scany/c1_phiyt1_%d.root", j), "root");
    cphiyt1[j]->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_scany/c1_phiyt1_%d.eps", j), "eps");
    cphiyt2[j]->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_scany/c1_phiyt2_%d.root", j), "root");
    cphiyt2[j]->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_scany/c1_phiyt2_%d.eps", j), "eps");  
  }
