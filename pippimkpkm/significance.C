...
{
  TFile *fsim = new TFile(Form("/Users/nacer/halld_my/pippimkpkm/input/pippimkpkm__B4_sim_recon17_1v03_%scut.root",cut.Data()));
  TFile *fdata = new TFile(Form("/Users/nacer/halld_my/pippimkpkm/input/pippimkpkm__B4_17v20_%scut.root",cut.Data()));
  ...
  TCanvas *cdata_PhiMass = new TCanvas("c_PhiMass","c_PhiMass",1500,800);
