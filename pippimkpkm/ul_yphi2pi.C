...
void ul_yphi2pi(TString name, int nkk=100, int n2pi2k=50, int ne=1, int nt=1) // , TString cut="&& kin_chisq<30 && abs(mm2)<0.015"
{
   TFile *fdata = NULL;
  ...
  // ++++++++++++++++++++++++++++ Cross-section  +++++++++++++++++++++++
    ...
    cphiyall1->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c1_phiyall_%s.root", name.Data()), "root");
    cphiyall1->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c1_phiyall_%s.eps", name.Data()), "eps");
    cphiyall1->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c1_phiyall_%s.png", name.Data()), "png");
    cphiyall2->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c2_phiyall_%s.root", name.Data()), "root");
    cphiyall2->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c2_phiyall_%s.eps", name.Data()), "eps");
    cphiyall2->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c2_phiyall_%s.png", name.Data()), "png");
    cphiyall->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_phiyall_%s.root", name.Data()), "root");
    cphiyall->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_phiyall_%s.eps", name.Data()), "eps");
    cphiyall->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_phiyall_%s.png", name.Data()), "png");
    cgphiyall->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_gphiyall_%s.root", name.Data()), "root");
    cgphiyall->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_gphiyall_%s.eps", name.Data()), "eps");
    cgphiyall->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_gphiyall_%s.png", name.Data()), "png");
    // cgnophiyall->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_gnophiyall.root", "root");
    // cgnophiyall->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_gnophiyall.eps", "eps");

/*
  // ======================================== Y vs. Eg ===============================================
  // root -l 'ul_yphi2pi.C+(50,50,4,4)'
  ...
  for (int j = 1; j <= ne; ++j)
  {
    ...
    cphiye1[j]->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c1_phiye_%d.root", j), "root");
    cphiye1[j]->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c1_phiye_%d.eps", j), "eps");
    cphiye1[j]->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c1_phiye_%d.png", j), "png");
    cphiye2[j]->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c2_phiye_%d.root", j), "root");
    cphiye2[j]->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c2_phiye_%d.eps", j), "eps");
    cphiye2[j]->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c2_phiye_%d.png", j), "png");
    // cphiye3[j]->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c3_phiye_%d.root", j), "root");
    // cphiye3[j]->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c3_phiye_%d.eps", j), "eps");
    // cphiye4[j]->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c4_phiye_%d.root", j), "root");
    // cphiye4[j]->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c4_phiye_%d.eps", j), "eps");

  }

  cphiye->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_phiye.root", "root");
  cphiye->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_phiye.eps", "eps");
  cphiye->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_phiye.png", "png");
  cgphiye->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_gphiye.root", "root");
  cgphiye->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_gphiye.eps", "eps");
  cgphiye->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_gphiye.png", "png");
  // cgnophiye->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_gnophiye.root", "root");
  // cgnophiye->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_gnophiye.eps", "eps");
*/
    /*
  // ======================================== Y vs. -t ===============================================
  ...
  for (int j = 1; j <= nt; ++j)
  {
    ...
    cphiyt1[j]->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c1_phiyt_%d.root", j), "root");
    cphiyt1[j]->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c1_phiyt_%d.eps", j), "eps");
    cphiyt2[j]->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c2_phiyt_%d.root", j), "root");
    cphiyt2[j]->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c2_phiyt_%d.eps", j), "eps");
  }

  cphiyt->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_phiyt.root", "root");
  cphiyt->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_phiyt.eps", "eps");
  cphiyt->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_phiyt.png", "png");
  cgphiyt->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_gphiyt.root", "root");
  cgphiyt->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_gphiyt.eps", "eps");
  cgphiyt->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_gphiyt.png", "png");
*/
    /*
  // ======================================== Y vs. (Eg,-t) ===============================================
  ...
  for (int j = 1; j <= ne*nt; ++j)
  {
    ...
    cphiy1[j]->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c1_phiy_%d.root", j), "root");
    cphiy1[j]->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c1_phiy_%d.eps", j), "eps");
    cphiy1[j]->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c1_phiy_%d.png", j), "png");
    cphiy2[j]->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c2_phiy_%d.root", j), "root");
    cphiy2[j]->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c2_phiy_%d.eps", j), "eps");
    cphiy2[j]->Print(Form("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c2_phiy_%d.png", j), "png");
  }

  cphiy->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_phiy.root", "root");
  cphiy->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_phiy.eps", "eps");
  cphiy->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_phiy.png", "png");
  cgphiy->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_gphiy.root", "root");
  cgphiy->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_gphiy.eps", "eps");
  cgphiy->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_gphiy.png", "png");
*/
  ...
  c_beame_tru->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_beame_tru.root", "root");
  c_beame_tru->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_beame_tru.eps", "eps");
  c_beame_tru->Print("/data.local/nacer/halld_my/pippimkpkm/fig_ul_yphi2pi/c_beame_tru.png", "png");
